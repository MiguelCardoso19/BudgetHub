...
import static com.authenticationMicroservice.exception.ErrorMessage.USERNAME_NOT_FOUND;
import static com.authenticationMicroservice.exception.ErrorMessage.USER_ID_NOT_FOUND;
...
public class UserNotFoundException extends Exception {
    ...
    public UserNotFoundException(String username) {
        ...
        this.errorCode = USERNAME_NOT_FOUND.getErrorCode();
    }
}