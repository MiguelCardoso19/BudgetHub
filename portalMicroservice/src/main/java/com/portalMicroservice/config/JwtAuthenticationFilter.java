...
import static com.portalMicroservice.enumerator.UserStatus.LOGGED_OUT;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        UserStatus userStatus = userCredentialsFeignClient.getUserStatus(request.getHeader("Nif"));
        if (userStatus == null || userStatus == LOGGED_OUT) {
